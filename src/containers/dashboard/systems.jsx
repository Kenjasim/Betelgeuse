...
const systems = [
  ...
  <SystemBox name="AIS" key="AIS" endpoint='pulsar.siriusinsight.io:3112' link='/ais' />,
  <SystemBox name="GPS" key="GPS" endpoint='pulsar.siriusinsight.io:3003' link='/' />,
  ...
  <SystemBox name="WiFi Pinger" key="WiFi Pinger" endpoint='pulsar.siriusinsight.io:3007' link='/wifi_pinger' />,
  ...
  <SystemBox name="Power" key="Power" endpoint='pulsar.siriusinsight.io:3111' link='/power' />,
  <SystemBox name="MRU" key="MRU" endpoint='pulsar.siriusinsight.io:3004' link='/mru' />,
  <SystemBox name="Weather" key="Weather" endpoint='pulsar.siriusinsight.io:3000'link='/weather' />
];
