...
const systems = [
  ...
  <SystemBox name="AIS" key="AIS" endpoint='https://sockets.siriusinsight.io/ais' link='/ais' />,
  <SystemBox name="GPS" key="GPS" endpoint='https://sockets.siriusinsight.io/gps' link='/' />,
  ...
  <SystemBox name="WiFi Pinger" key="WiFi Pinger" endpoint='https://sockets.siriusinsight.io/wifi' link='/wifi_pinger' />,
  ...
  <SystemBox name="Power" key="Power" endpoint='https://sockets.siriusinsight.io/power' link='/power' />,
  <SystemBox name="MRU" key="MRU" endpoint='https://sockets.siriusinsight.io/mru' link='/mru' />,
  <SystemBox name="Weather" key="Weather" endpoint='https://sockets.siriusinsight.io/weather'link='/weather' />
];
